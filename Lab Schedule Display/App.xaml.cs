...
namespace Lab_Schedule_Display
{
    ...
    sealed partial class App : Application
    {
        ...
        public string connectionStringRemote = @"Server=DESKTOP-F0I39D9; Database=LabSchedule; Integrated Security=False; User ID=kiosk; Password=kiosk; Persist Security Info=False;";
